...
public class CycloPluginLayer extends OsmandMapLayer implements QuickActionRegistry.QuickActionUpdatesListener, QuickAction.QuickActionSelectionListener {
    ...
    private CycloPlugin cycloPlugin;
    ...
    public CycloPluginLayer(MapActivity activity, CycloPlugin pluigin) {
	...
	public boolean setLayerState(boolean showWidget) {
		...
		if (!showWidget) {
		    ...
		    quickActionRegistry.setUpdatesListener(CycloPluginLayer.this);
		    quickActionsWidget.setSelectionListener(CycloPluginLayer.this);
		}
    ...
    private void setupQuickActionBtnVisibility() {
      /*  MapContextMenu contextMenu = mapActivity.getContextMenu();
        ...
        quickActionButton.setVisibility(View.VISIBLE);
    }
