...
public class CycloUIWidget extends FrameLayout {
    ...
    public CycloUIWidget(Context context) {
        super(context);
    }

    public CycloUIWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CycloUIWidget(Context context, AttributeSet attrs, int defStyleAttr) {
